...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', gap: SPACING.md, padding: SPACING.md, backgroundColor: COLORS.surface, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  headerCopy: { flex: 1 }, eyebrow: { color: COLORS.primaryDark, fontSize: 12, fontWeight: '800', letterSpacing: 1.2 },
  title: { color: COLORS.text, fontSize: 22, lineHeight: 28, fontWeight: '800', marginTop: 2 }, subtitle: { color: COLORS.textSecondary, fontSize: 13, lineHeight: 18, marginTop: 3 },
  close: { width: 40, height: 40, borderRadius: 20, backgroundColor: COLORS.cardBackground, alignItems: 'center', justifyContent: 'center' },
  sourceActions: { flexDirection: 'row', flexWrap: 'wrap', gap: SPACING.sm, padding: SPACING.md, backgroundColor: COLORS.surface },
  primaryButton: { flexGrow: 1, minWidth: 180, minHeight: 44, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, flexDirection: 'row', gap: SPACING.sm, alignItems: 'center', justifyContent: 'center', paddingHorizontal: SPACING.md },
  secondaryButton: { flexGrow: 1, minWidth: 120, minHeight: 44, borderRadius: RADIUS.md, backgroundColor: COLORS.cardBackground, borderWidth: 1, borderColor: COLORS.border, flexDirection: 'row', gap: SPACING.sm, alignItems: 'center', justifyContent: 'center', paddingHorizontal: SPACING.md },
